...
out_dir = "/Users/congwu/Desktop/instagram-carousels/episodes/260607_never-say/v8"
...
css = """
  ...
  body { 
    background: #FFFFFF; 
    color: #0F172A; 
    font-family: 'Suisse Int\\'l', 'Suisse Intl', sans-serif;
  }
...
<style>
  @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@200;300;600;700;800&display=swap');
  :root {{ --accent: #FFE054; }}
  body {{ font-family: 'Suisse Int\\'l', 'Suisse Intl', sans-serif; }}
  .card {{
    width: 1080px; height: 1350px;
    background-image: linear-gradient(135deg, rgba(26, 73, 216, 0.92) 0%, rgba(15, 23, 42, 0.96) 100%), url('../v6/cover_bg.jpg');
